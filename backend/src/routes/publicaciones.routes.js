...
import { getPublis, getPubli, createPubli, updatePubli, deletePubli, filter } from '../controllers/publicaciones.controller.js'
...
router.post('/publicaciones/filtro', filter)
